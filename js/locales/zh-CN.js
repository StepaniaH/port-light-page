...
export default {
  ...
  'f7.t': '懂你的配色',
  'f7.b': '从 Gruvbox 到 Kanagawa 共 10 个配色族，明暗两套；7 种界面语言。',
  'f8.t': '数据不出机器',
  'f8.b': '无遥测、无账号、无云端。端口地图永远留在你的主机上。',
  'f9.t': '空闲段规划器',
  'f9.b': '找出范围内最大的连续空闲段，并可一次性原子预留。',
  ...
  'theme.nord-light': 'Nord 浅色',
  'theme.dracula-light': 'Dracula 浅色',
  'theme.tokyo-night-light': 'Tokyo Night 浅色',
  'theme.one-dark-light': 'One Dark 浅色',
  'theme.everforest-light': 'Everforest 浅色',
  ...
  "faq.kicker": "常见问题",
  "faq.title": "常见问题，快速解答。",
  "faq.q1": "docker.sock：权限被拒？",
  "faq.a1": "Compose 文件以只读方式挂载 /var/run/docker.sock。若容器日志出现权限错误，请确认主机上的 socket 路径正确、容器用户可读 —— 无需特权模式。",
  "faq.q2": "我的 Compose 项目没有显示？",
  "faq.a2": "将 COMPOSE_SCAN_DIR 指向存放 Compose 项目的目录（最多 4 层深、不超过 400 个文件）。即使项目已停止，声明的端口也会计入 —— 显示为 configured。",
  "faq.q3": "可以把 Port-Light 暴露到公网吗？",
  "faq.a3": "不建议。它只在局域网内提供一个只读页面 —— 请置于 Basic Auth 或反向代理之后，不要暴露到公网。安全清单中有加固建议。",
  "faq.q4": "Agent 如何预留空闲端口？",
  "faq.a4": "调用 GET /api/ports/suggest?reserve=true 即可返回当前空闲的端口，并以到期自动释放的租约持有。Agent 技能与 MCP 服务器封装了相同端点。",
};
